...
const UploadImage = () => {
  ...
  const [editedOnroadImage,  setEditedOnroadImage] = useState({
  ...
  const handleImageChange = (e) => {
    setEditedOnroadImage({
      ...editedOnroadImage,
      image: e.target.files[0]
    });
  };

  const handleUpdateOnroadImage = async (e) => {
    e.preventDefault();
    try {
      const formData = new FormData();
      formData.append('image', editedOnroadImage.image);
      
      const response = await fetch(`http://localhost:4000/api/v1/business/upload_image/${id}`, {
        method: 'PUT',
        headers: {
          'x-auth-token': token,
        },
      ...
      <div className="offcanvas-body">
        <div className="sidenav-profile">
          ...
          <div className="user-info">
            <h6 className="user-name mb-1">Orphan Helper On Roadside</h6>
        ...
        <div className="profile-wrapper-area py-3">
          <div className="card user-data-card">
            <div className="card-body">
              <form onSubmit={handleUpdateOnroadImage} >
              <div className="mb-3">
