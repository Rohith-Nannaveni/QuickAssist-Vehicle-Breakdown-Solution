    ...
    const fetchBusinessData = async () => {
      try {
        ...
        const vendoremail = decodeURIComponent(document.cookie.replace(/(?:(?:^|.*;\s*)vendoremail\s*=\s*([^;]*).*$)|^.*$/, '$1'));
         ...
         const filteredBusiness = data.filter((location) => location.vendoremail === vendoremail);
            ...
            <div className="row" style={{marginTop:10}}>
              ...
              <div className="card product-card" style={{marginBottom:10}}>
                <div className="card-body"    >
                  ...
                  <a className="btn btn-danger" onClick={() => UpdateStatus(location.id)}>Update Status</a> 
