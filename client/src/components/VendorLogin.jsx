...
const VendorLogin = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:4000/api/v1/vendor/login', {
        email: email,
        password: password,
      });
      ...
      <title>Onroad Vehicle Break Down Assitance </title>
        ...
        <div className="background-shape"></div>
             <div className="container">
                ...
                <img className="big-logo" src={imgfolder} alt="" ></img> <p style={{color:'white'}}>Vendor Login</p>               
                        ...
                        <div className="login-meta-data"><a className="forgot-password d-block mt-3 mb-1" href="reset_password_vendor">Forgot Password?</a>
                        <p className="mb-0">Didn't have an account?<Link to="/vendor_register" className="ms-1" >Register Now</Link></p>
