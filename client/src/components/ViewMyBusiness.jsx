    ...
    const fetchBusinessData = async () => {
      try {
        ...
        const vendoremail = decodeURIComponent(document.cookie.replace(/(?:(?:^|.*;\s*)vendoremail\s*=\s*([^;]*).*$)|^.*$/, '$1'));
         ...
         const filteredBusiness = data.filter((business) => business.vendoremail === vendoremail);
            ...
            {/* Get Details Map field and id */}          
              ...
              <div className="card product-card" style={{marginBottom:10}}>
                <div className="card-body"    >
                      ...
                      <a className="product-title d-block"  > Name:  <b>  {business.mechanicname} </b></a>
                      <a className="product-title d-block"  >Type:  <b>  {business.type} </b></a>
                 ...
                 <a className="btn btn-danger" target="_blank"
                  ...
                  Show Map
                    ...
                    <p>No business details found for the specified vendor email or search term.</p>
            )}
